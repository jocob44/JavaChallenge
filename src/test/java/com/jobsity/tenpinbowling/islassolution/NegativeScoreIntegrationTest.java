...
@SpringBootTest(properties = {"inputPath=negative/negative.txt"})
class NegativeScoreIntegrationTest {
    ...
    @Test void negativeScoreShouldFail(){
        ...
        assert thrown.getMessage().contains("The input is not in correct format, the score should greater than or equal 0");
